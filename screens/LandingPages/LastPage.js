...
export class LastPage extends Component {
    render() {
        return (
            ...
            <Text style={styles.mainSecondText}>Do you have an account? Login</Text>
            <View style={styles.textInputView}>
            <TextInput textAlign="left" style={styles.mainThirdText}>Firs Name</TextInput>
            
            </View>
            <View style={styles.textInputView}>
            <TextInput textAlign="left" style={styles.mainThirdText}>Second Name</TextInput>
            ...
            <Text textAlign="left" style={styles.registerButtonText}>Register</Text>
            </TouchableOpacity>
            </View>
